  ...
  window.addEventListener(
    ...
    function (e) {
      ...
      /* #################################### */
        ...
        // stars rotating
        document.querySelectorAll('.star-image').forEach(function(star) {
          gsap.to(star, {
            scrollTrigger: {
              trigger: star,
        ...
        if(marqueeInner) {
          ...
          // Calculate the width of the marquee text
          ...
          const animateMarquee = () => {
            ...
            gsap.set(marqueeInner, { x: window.innerWidth });

            // Animate to move to the left beyond its own width
            gsap.to(marqueeInner, {
              x: -marqueeWidth,
              duration: 10, // Duration of the animation in seconds, adjust as needed for speed
              ease: "linear", // Linear animation for a smooth continuous effect
              onComplete: animateMarquee, // Call the function again to create an infinite loop
            });
          };
